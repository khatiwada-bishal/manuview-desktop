...
- **Timestamp**: 2026-09-16T03:04:39.849Z
- **Engine Commit**: `HEAD`
...
|---|---|---|---|---|---|---|---|
| pValueFromT/F/ChiSquare/Z/R | Layer A | Max abs error | 6.59e-4 | < 2e-3 | 100% | n/a | ✅ Pass |
| runStatcheckAudit (inconsistency flags) | Layer A | F1 | 0.89 [1.00 prec, 0.80 rec] | ≥ 0.85 | 100% | n/a | ✅ Pass |
| testGrim (granularity of means) | Layer A | Accuracy | 1.00 [0.89–1.00] | ≥ 0.98 | 100% | n/a | ✅ Pass |
| analyzeCitationRecency | Layer A | Max abs error | 0.00 | 0.00 (exact) | 100% | n/a | ✅ Pass |
| isStructuralAnchorResolvable (grounding gate) | Layer A | Precision | 1.00 [0.65–1.00] | ≥ 0.95 | 100% | n/a | ✅ Pass |
| lookupJournalInCatalog | Layer A | Precision | 1.00 [0.78–1.00] | ≥ 0.98 | 100% | n/a | ✅ Pass |
...
| checkRetractionStatus (offline catalog) | Layer B | FPR | 0.00 [0.00–0.49] | ≤ 0.02 | 100% | 0.00 | ✅ Pass |
